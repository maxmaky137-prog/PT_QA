...
const App: React.FC = () => {
  ...
  const [settings, setSettings] = useState<AppSettings>({
    ...
    telegramBotToken: '',
    telegramChatId: '',
    googleScriptUrl: 'https://script.google.com/macros/s/AKfycbwNijcKqa1GrH4SsjsiUmlMaMXrhIMbaQMlmyh1WnJMM8GDd9xMQHhv6hEyxkntTp0/exec', // Pre-filled URL
  ...
  const loadSettings = () => {
    ...
    if (saved) {
        ...
        if(!parsed.googleScriptUrl) parsed.googleScriptUrl = 'https://script.google.com/macros/s/AKfycbwNijcKqa1GrH4SsjsiUmlMaMXrhIMbaQMlmyh1WnJMM8GDd9xMQHhv6hEyxkntTp0/exec';
